...
namespace BooksAssignment.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        /// </returns>
        [HttpPost]
        public async Task<ActionResult<AddBookResponse>> AddNewBook ([FromBody]AddBookRequest request)
        {
            try
            {
                var result = await _booksService.AddNewBook(request.Title, request.Author, (int)request.Year, request.Publisher, request.Description);
                return Ok(result);
            }
        ...
        /// </returns>
        [HttpGet]
        public async Task<ActionResult<List<BookDto>>> GetBooks ([FromQuery]GetBooksRequest request)
        {
